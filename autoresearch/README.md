...
| `train_seed.py` | The **starting** script, not the champion, so you begin where the campaign began. |
...
3. Write a `train_seed.py` that runs end to end and scores *something*, however
   weak. The agent needs a working baseline, not a good one.
