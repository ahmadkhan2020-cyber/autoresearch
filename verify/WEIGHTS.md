...
**This file is not in the repository yet, and it has to come from the machine
that ran the campaign.** Nothing in this package can regenerate it: weights are
the product of a specific training run on specific hardware, not something that
can be reconstructed from source.
