...
| `last_model.pt` | Champion weights, so you can score without retraining. **Not yet included** — see [`WEIGHTS.md`](WEIGHTS.md). |
...
| `RECONSTRUCTION.md` | Only relevant if you are using the reconstructed `train.py`. |
